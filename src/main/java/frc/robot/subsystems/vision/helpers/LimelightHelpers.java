...
public class LimelightHelpers {
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName) {
        ...
        var est = new PoseEstimate();
        est.pose = pose;
        est.timestampSeconds = adjustedTimestamp;
        est.latency = latency;
        est.tagCount = tagCount;
        est.tagSpan = tagSpan;
        est.avgTagDist = tagDist;
        est.avgTagArea = tagArea;
        est.rawFiducials = rawFiducials;
