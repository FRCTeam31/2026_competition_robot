...
public class LimelightTarget_Retro implements LoggableInputs, Cloneable {
    ...
    public LimelightTarget_Retro clone() {
        LimelightTarget_Retro copy = new LimelightTarget_Retro();
