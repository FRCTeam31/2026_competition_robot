...
public class TurretUtilities {
         ...
         *
         * Uses the optimal angle formula: 45-degrees + (arctan(deltaH / distance) / 2)
         ...
         * @param minAngle            The minimum allowed launch angle (degrees, from vertical -- 0-degrees is
         *                            straight up)
        ...
        public static void calculateAimVector(MutVector result, Pose3d sourcePose, Pose3d targetPose,
                ...
                // Utilize optimal angle formula: 45-degrees + (arctan(deltaH / distance) / 2)
