...
public class PrimeHolonomicDriveController implements PathFollowingController {
     ...
     */
    public PrimeHolonomicDriveController(
    ...
    /**
     * Super easy function to write to not make this stupid class a black box
     * @return
     */
    ...
    public static void setRotationTargetOverride(
        ...
        PrimeHolonomicDriveController.rotationTargetOverride = rotationTargetOverride;
    }
    ...
    public static void overrideXFeedback(DoubleSupplier xFeedbackOverride) {
        PrimeHolonomicDriveController.xFeedbackOverride = xFeedbackOverride;
    }
    ...
    public static void clearXFeedbackOverride() {
        PrimeHolonomicDriveController.xFeedbackOverride = null;
    }
    ...
    public static void overrideYFeedback(DoubleSupplier yFeedbackOverride) {
        PrimeHolonomicDriveController.yFeedbackOverride = yFeedbackOverride;
    }
    ...
    public static void clearYFeedbackOverride() {
        PrimeHolonomicDriveController.yFeedbackOverride = null;
    }
    ...
    public static void overrideRotationFeedback(DoubleSupplier rotationFeedbackOverride) {
        PrimeHolonomicDriveController.rotFeedbackOverride = rotationFeedbackOverride;
    }
    ...
    public static void clearRotationFeedbackOverride() {
        PrimeHolonomicDriveController.rotFeedbackOverride = null;
    }
